...
EMNLP 2024（Conference on Empirical Methods in Natural Language Processing）会议论文的解析归档。

<!-- 胶囊徽章带：论文数 / 最近更新 / 流水线 / License -->
![Papers](https://img.shields.io/badge/Papers-165-brightgreen?style=flat-square)
![Last commit](https://img.shields.io/github/last-commit/ZhangCurosr/zhangcursor-papers-emnlp-2024-001?style=flat-square)
...
- **内容**：EMNLP 2024 主会论文（含 Long / Short / Findings）。
- **来源**：https://aclanthology.org/events/emnlp-2024/
...
# 按标题搜索（示例）
git ls-remote https://github.com/ZhangCurosr/zhangcursor-papers-emnlp-2024-001.git
```
...
- 仅收录 MinerU 服务可达的论文源（本库为 EMNLP 2024）
